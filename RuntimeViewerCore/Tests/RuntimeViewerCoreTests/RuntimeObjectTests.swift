...
struct RuntimeObjectTests {
    ...
    func initSetsAllProperties() {
        ...
        #expect(object.properties == [.isSwiftClass])
    ...
    func withImagePath() {
        ...
        #expect(newObject.properties == object.properties)
    ...
    func withAppendedChildOnEmpty() {
        let parent = RuntimeObject(name: "Box", displayName: "Box", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
        let child = RuntimeObject(name: "BoxOfInt", displayName: "BoxOfInt", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
    ...
    func withAppendedChildAccumulates() {
        ...
        let parent = RuntimeObject(name: "Box", displayName: "Box", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
        let child1 = RuntimeObject(name: "BoxOfInt", displayName: "BoxOfInt", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
        let child2 = RuntimeObject(name: "BoxOfString", displayName: "BoxOfString", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
    ...
    func withAppendedChildPreservesProperties() {
        ...
        let child = RuntimeObject(name: "BoxOfInt", displayName: "BoxOfInt", kind: .swift(.type(.struct)), imagePath: "/p", children: [], properties: [.isSpecialized])
        let updated = parent.withAppendedChild(child)
    ...
    func runtimeObjectKeyIgnoresChildren() {
        ...
        let bare = RuntimeObject(name: "Box", displayName: "Box", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
        let child = RuntimeObject(name: "BoxOfInt", displayName: "BoxOfInt", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
    ...
    func runtimeObjectKeyDiscriminates() {
        let a = RuntimeObject(name: "Box", displayName: "Box", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
        let differentImage = RuntimeObject(name: "Box", displayName: "Box", kind: .swift(.type(.struct)), imagePath: "/q", children: [])
        let differentName = RuntimeObject(name: "BoxOfInt", displayName: "Box", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
        let differentKind = RuntimeObject(name: "Box", displayName: "Box", kind: .swift(.type(.class)), imagePath: "/p", children: [])
    ...
    func equality() {
        let a = RuntimeObject(name: "A", displayName: "A", kind: .c(.struct), imagePath: "/p", children: [])
        let b = RuntimeObject(name: "A", displayName: "A", kind: .c(.struct), imagePath: "/p", children: [])
        #expect(a == b)
    }
    ...
    func inequalityByName() {
        let a = RuntimeObject(name: "A", displayName: "A", kind: .c(.struct), imagePath: "/p", children: [])
        let b = RuntimeObject(name: "B", displayName: "A", kind: .c(.struct), imagePath: "/p", children: [])
        #expect(a != b)
    }
    ...
    func hashConsistency() {
        let a = RuntimeObject(name: "X", displayName: "X", kind: .swift(.type(.enum)), imagePath: "/p", children: [])
        let b = RuntimeObject(name: "X", displayName: "X", kind: .swift(.type(.enum)), imagePath: "/p", children: [])
    ...
    func setStorage() {
        let a = RuntimeObject(name: "A", displayName: "A", kind: .c(.struct), imagePath: "/p", children: [])
        let b = RuntimeObject(name: "B", displayName: "B", kind: .c(.union), imagePath: "/p", children: [])
    ...
    func sorting() {
        let objcClass = RuntimeObject(name: "B", displayName: "B", kind: .objc(.type(.class)), imagePath: "/a", children: [])
        let swiftStruct = RuntimeObject(name: "A", displayName: "A", kind: .swift(.type(.struct)), imagePath: "/a", children: [])
        let cStruct = RuntimeObject(name: "C", displayName: "C", kind: .c(.struct), imagePath: "/a", children: [])
    ...
    func codable() throws {
        let original = RuntimeObject(
            ...
            imagePath: "/System/Library/Frameworks/AppKit.framework/Versions/C/AppKit",
            children: [
                RuntimeObject(name: "Child", displayName: "Child", kind: .c(.struct), imagePath: "/path", children: []),
            ],
            properties: [.isSwiftClass]
        )
    ...
    func exportFileNameSwiftType() {
        let object = RuntimeObject(name: "MyStruct", displayName: "MyStruct", kind: .swift(.type(.struct)), imagePath: "/p", children: [])
    ...
    func exportFileNameSwiftExtension() {
        let object = RuntimeObject(name: "MyClass", displayName: "MyClass", kind: .swift(.extension(.class)), imagePath: "/p", children: [])
    ...
    func exportFileNameSwiftConformance() {
        let object = RuntimeObject(name: "MyEnum", displayName: "MyEnum", kind: .swift(.conformance(.enum)), imagePath: "/p", children: [])
    ...
    func exportFileNameObjCClass() {
        let object = RuntimeObject(name: "NSObject", displayName: "NSObject", kind: .objc(.type(.class)), imagePath: "/p", children: [])
    ...
    func exportFileNameObjCProtocol() {
        let object = RuntimeObject(name: "NSCoding", displayName: "NSCoding", kind: .objc(.type(.protocol)), imagePath: "/p", children: [])
        #expect(object.exportFileName == "NSCoding-Protocol.h")
    }

    @Test("C struct export produces .h extension")
    func exportFileNameCStruct() {
        let object = RuntimeObject(name: "CGRect", displayName: "CGRect", kind: .c(.struct), imagePath: "/p", children: [])
        #expect(object.exportFileName == "CGRect.h")
    }

    @Test("ObjC category export uses +CategoryName.h format")
    func exportFileNameObjCCategory() {
        let object = RuntimeObject(name: "NSObject(MyCategory)", displayName: "NSObject(MyCategory)", kind: .objc(.category(.class)), imagePath: "/p", children: [])
    ...
    func exportFileNameSanitization() {
        let object = RuntimeObject(name: "NS/Obj:ect", displayName: "NS/Obj:ect", kind: .objc(.type(.class)), imagePath: "/p", children: [])
    ...
    func exportFileNameCppTemplateSanitization() {
        let object = RuntimeObject(name: "std::vector<std::pair<int, float>>", displayName: "std::vector<std::pair<int, float>>", kind: .c(.struct), imagePath: "/p", children: [])
