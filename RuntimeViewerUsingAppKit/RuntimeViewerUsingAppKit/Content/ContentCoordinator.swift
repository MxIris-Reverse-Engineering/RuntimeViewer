...
final class ContentCoordinator: ViewCoordinator<ContentRoute, ContentTransition> {
    ...
    private lazy var textViewController: AppKitViewController<ContentTextViewModel> = makeTextViewController(kind: desiredEditorKind())
    ...
    private func makeTextViewController(kind: EditorKind) -> AppKitViewController<ContentTextViewModel> {
        switch kind {
