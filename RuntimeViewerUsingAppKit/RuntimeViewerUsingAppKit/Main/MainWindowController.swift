...
final class MainWindowController: XiblessWindowController<MainWindow> {
    ...
    override func synchronizeWindowTitleWithDocumentName() {
        ...
        contentWindow.title = appServices.runtimeEngine.source.description
    }
    ...
    func setupBindings(for viewModel: MainViewModel) {
        ...
        appServices.$currentImageName
            .asDriver()
            .driveOnNext { [weak self] imageName in
                guard let self else { return }
                var title = appServices.runtimeEngine.source.description
