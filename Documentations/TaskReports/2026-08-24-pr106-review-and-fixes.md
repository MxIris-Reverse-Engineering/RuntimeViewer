...
对 PR #106（`feature/inject-ios-simulator-process` → `next`，Evolution 0013 模拟器注入，
...
| `e2856885` docs | 十四条四问裁决 + 三条顺带发现；索引与 0013 决策日志 | `KnownIssues/2026-08-24-pr106-review-findings.md`(新)、`KnownIssues/README.md`、`Evolutions/0013-*.md` |
